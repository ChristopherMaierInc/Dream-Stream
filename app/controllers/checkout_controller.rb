class CheckoutController < ApplicationController
  def create
    ...
    PurchaseMailer.mail_purchase_notification(customer.email, notification).deliver_now

    confirmation = "Your order #{@order} was successfully made and your card was charged for $#{@price_in_dollars}. Please contact us on our website if you experience any issues."

    PurchaseMailer.mail_purchase_confirmation(customer.email, confirmation).deliver_now
